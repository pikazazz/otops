                            ...
                            @foreach ($News as $new)
                                <tr>
                                    ...
                                    <td class="project-actions text-left">
                                        <form action="{{ route('News.show', $new->id) }}" method="POST">
                                            @csrf
                                            @method('get')
                                            <button class="btn btn-primary btn-sm" type="submit" name="view"
                                                value="{{ $new->id }}"> <i class="fas fa-folder"
                                                    style="color: white">
                                                </i>
                                                View
                                            </button>
                                        ...
                                        <form action="{{ route('News.edit', $new->id) }}" method="POST">
                                            ...
                                            <button class="btn btn-info btn-sm" type="submit" name="edit"
                                                value="{{ $new->id }}"> <i class="fas fa-pencil-alt"
                                                    style="color: white">
                                                </i>
                                                Edit
                                            </button>
                                        ...
                                        <form action="{{ route('News.destroy', $new->id) }}" method="POST">
                                            ...
                                            <button class="btn btn-danger btn-sm" type="submit" name="del"
                                                value="{{ $new->id }}"> <i class="fas fa-trash"
                                                    style="color: white">
                                                </i>
                                                Delete</button>
                                        </form>
